package com.neo.dishathome.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.neo.dishathome.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.neo.dishathome.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
